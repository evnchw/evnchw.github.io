...
In this section we review probability spaces and measures, distance between measures, and recap differentiation wrt. probability measures can occur (following the Delarue notes). We review necessary concepts from measure theory and other fields when necessary.

### Preliminaries: probability spaces, measures and distances
...
- The third component $P: \mathcal{F} \to [0,1]$ ("probability measure") is the measure assigned to every element of $\mathcal{F}$
  - It must sum to one over the whole space ($P(\Omega)=1$).
